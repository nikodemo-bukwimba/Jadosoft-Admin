# ============================================================
# Level2WiringGenerator.psm1 — DI + Routes + Nav
# Same as Level 3 but NO workflow executor registration.
# ============================================================
...
function Update-InjectionContainer {
    ...
    # NO workflow executor — that's Level 3 only
...
function Update-ShellNavItems {
    ...
    $tab = @"
      // $flabel tab (Level 2, generated $(Get-Date -Format 'yyyy-MM-dd'))
      ShellTabConfig(
        label:      '$flabel',
        icon:       $icon,
