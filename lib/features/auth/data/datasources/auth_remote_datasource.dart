...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  Future<Map<String, dynamic>> login(String email, String password) async {
    try {
      ...
      if (kDebugMode) {
        ...
        debugPrint('[AUTH] Token extracted: ${token != null ? "YES (${token.length} chars)" : "NO — check response shape"}');
      }
  ...
  Future<Map<String, dynamic>> register({
    ...
    try {
      ...
      if (kDebugMode) {
        ...
        final token = _extractToken(body);
        debugPrint('[AUTH] Token extracted: ${token != null ? "YES" : "NO — check response shape"}');
      }
  ...
  Future<UserModel> getUser() async {
    try {
      ...
      if (data == null) throw const ServerException('Empty response from /user');
  ...
  Future<Map<String, dynamic>> getRolesAndPermissions() async {
    try {
      ...
      if (body == null) throw const ServerException('Empty response from /me/roles');
  ...
  Map<String, dynamic> _parseBody(Response response) {
    ...
    if (data is! Map<String, dynamic>) throw const ServerException('Unexpected response format');
    return data;
  }
