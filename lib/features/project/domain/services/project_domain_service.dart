...
class ProjectDomainService {
  ...
  Future<Either<Failure, ProjectEntity>> transition({
    required String id,
    required ProjectStatus targetStatus,
  }) async {
    // 1. Load
